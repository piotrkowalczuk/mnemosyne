...
func (*SetValueRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*SetValueResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
func (c *sessionManagerClient) Exists(ctx context.Context, in *ExistsRequest, opts ...grpc.CallOption) (*google_protobuf2.BoolValue, error) {
...
func (c *sessionManagerClient) Abandon(ctx context.Context, in *AbandonRequest, opts ...grpc.CallOption) (*google_protobuf2.BoolValue, error) {
	out := new(google_protobuf2.BoolValue)
...
func (c *sessionManagerClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf2.Int64Value, error) {
	out := new(google_protobuf2.Int64Value)
...
func init() { proto.RegisterFile("mnemosynerpc/session.proto", fileDescriptor0) }
