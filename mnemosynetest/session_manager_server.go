...
func (_m *SessionManagerServer) Abandon(_a0 context.Context, _a1 *mnemosynerpc.AbandonRequest) (*wrapperspb.BoolValue, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *wrapperspb.BoolValue
	if rf, ok := ret.Get(0).(func(context.Context, *mnemosynerpc.AbandonRequest) *wrapperspb.BoolValue); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *SessionManagerServer) Context(_a0 context.Context, _a1 *emptypb.Empty) (*mnemosynerpc.ContextResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *mnemosynerpc.ContextResponse
	if rf, ok := ret.Get(0).(func(context.Context, *emptypb.Empty) *mnemosynerpc.ContextResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *SessionManagerServer) Delete(_a0 context.Context, _a1 *mnemosynerpc.DeleteRequest) (*wrapperspb.Int64Value, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *wrapperspb.Int64Value
	if rf, ok := ret.Get(0).(func(context.Context, *mnemosynerpc.DeleteRequest) *wrapperspb.Int64Value); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *SessionManagerServer) Exists(_a0 context.Context, _a1 *mnemosynerpc.ExistsRequest) (*wrapperspb.BoolValue, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *wrapperspb.BoolValue
	if rf, ok := ret.Get(0).(func(context.Context, *mnemosynerpc.ExistsRequest) *wrapperspb.BoolValue); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*wrapperspb.BoolValue)
