...
func (_m *SessionManagerServer) Abandon(_a0 context.Context, _a1 *mnemosynerpc.AbandonRequest) (*mnemosynerpc.AbandonResponse, error) {
...
func (_m *SessionManagerServer) Delete(_a0 context.Context, _a1 *mnemosynerpc.DeleteRequest) (*mnemosynerpc.DeleteResponse, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *SessionManagerServer) Exists(_a0 context.Context, _a1 *mnemosynerpc.ExistsRequest) (*mnemosynerpc.ExistsResponse, error) {
	ret := _m.Called(_a0, _a1)
